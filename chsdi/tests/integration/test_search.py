...
class TestSearchServiceView(TestsBase):
    ...
    def test_search_layers(self):
        ...
        self.assertTrue(resp.json['results'][0]['attrs']['lang'] == 'de')
    ...
    def test_search_layers_all_langs(self):
        ...
        for lang in langs:
            ...
            self.assertTrue(resp.content_type == 'application/json')
            self.assertTrue(resp.json['results'][0]['attrs']['lang'] == lang)
    ...
    def test_search_locations_prefix_sentence_match(self):
        ...
        self.assertTrue(resp.content_type == 'application/json')
        self.assertTrue(resp.json['results'][0]['attrs']['detail'] == 'lausanne vd')
        self.assertTrue(resp.json['results'][0]['attrs']['origin'] == 'gg25')
    ...
    def test_search_locations_wil(self):
        ...
        self.assertTrue(resp.content_type == 'application/json')
        self.assertTrue(resp.json['results'][0]['attrs']['detail'][:3] == 'wil')
    ...
    def test_search_locations_fontenay(self):
        ...
        self.assertTrue(resp.content_type == 'application/json')
        self.assertTrue(resp.json['results'][0]['attrs']['detail'] == 'chemin de fontenay 10 1007 lausanne 5586 lausanne ch vd')
    ...
    def test_locations_searchtext_apostrophe(self):
        ...
        self.assertTrue(resp.content_type == 'application/json')
        self.assertTrue(resp.json['results'][0]['attrs']['detail'] == 'avenue du mont-d\'or 1 1007 lausanne 5586 lausanne ch vd')
        self.assertTrue(resp.json['results'][0]['attrs']['num'] == 1)
    ...
    def test_address_order(self):
        ...
        self.assertTrue(resp.content_type == 'application/json')
        self.assertTrue(resp.json['results'][0]['attrs']['detail'] == 'chemin isabelle-de-montolieu 1 1010 lausanne 5586 lausanne ch vd')
        self.assertTrue(resp.json['results'][0]['attrs']['num'] == 1)
    ...
    def test_search_address_with_letters(self):
        ...
        self.assertTrue(resp.content_type == 'application/json')
        self.assertTrue(resp.json['results'][1]['attrs']['detail'] == 'rhonesandstrasse 16a 3900 brig 6002 brig-glis ch vs')
    ...
    def test_search_locations_with_bbox(self):
        ...
        resp = self.testapp.get('/rest/services/inspire/SearchServer', params=params, status=200)
        self.assertTrue(resp.json['results'][0]['attrs']['detail'] == 'buechli  5306 tegerfelden 4320 tegerfelden ch ag')
        self.assertTrue(len(resp.json['results']) == 1)
