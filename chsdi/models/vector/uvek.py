...
class GeakExperten (Base, Vector):
    ...
    experience_text_it = Column('experience_text_it', Unicode)
    experience_text_de = Column('experience_text_de', Unicode)
    experience_text_fr = Column('experience_text_fr', Unicode)
