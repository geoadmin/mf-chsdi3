...
register(Geologischer_Inklination.__bodId__, Geologischer_Inklination)
...
register(GeologischerAtlasLineAux.__bodId__, GeologischerAtlasLineAux)
register(GeologischerAtlasPointHydro.__bodId__, GeologischerAtlasPointHydro)
register(GeologischerAtlasPointGeol.__bodId__, GeologischerAtlasPointGeol)
register(GeologischerAtlasPointDrill.__bodId__, GeologischerAtlasPointDrill)
register(GeologischerAtlasPointInfo.__bodId__, GeologischerAtlasPointInfo)
register(GeologischerAtlasPointStruct.__bodId__, GeologischerAtlasPointStruct)
register(GeologischerAtlasPolygonAux1.__bodId__, GeologischerAtlasPolygonAux1)
register(GeologischerAtlasPolygonAux2.__bodId__, GeologischerAtlasPolygonAux2)
register(GeologischerAtlasPolygonMain.__bodId__, GeologischerAtlasPolygonMain)
...
register(Swissnames3dRaster00.__bodId__, Swissnames3dRaster00)
register(Swissnames3dRaster01.__bodId__, Swissnames3dRaster01)
register(Swissnames3dRaster02.__bodId__, Swissnames3dRaster02)
register(Swissnames3dRaster03.__bodId__, Swissnames3dRaster03)
register(Swissnames3dRaster04.__bodId__, Swissnames3dRaster04)
register(Swissnames3dRaster05.__bodId__, Swissnames3dRaster05)
register(Swissnames3dRaster06.__bodId__, Swissnames3dRaster06)
register(Swissnames3dRaster07.__bodId__, Swissnames3dRaster07)
register(Swissnames3dRaster08.__bodId__, Swissnames3dRaster08)
register(Swissnames3dRaster09.__bodId__, Swissnames3dRaster09)
register(Swissnames3dRaster10.__bodId__, Swissnames3dRaster10)
register(Swissnames3dRaster11.__bodId__, Swissnames3dRaster11)
register(Swissnames3dRaster12.__bodId__, Swissnames3dRaster12)
register(Swissnames3dRaster13.__bodId__, Swissnames3dRaster13)
