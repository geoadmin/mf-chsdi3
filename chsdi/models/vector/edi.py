...
class Gebaeuderegister(Base, Vector):
    ...
    gksce_de = Column('gksce_de', Unicode)
    gksce_fr = Column('gksce_fr', Unicode)
    gksce_it = Column('gksce_it', Unicode)
    gstat = Column('gstat', SmallInteger)
    gstat_de = Column('gstat_de', Unicode)
    gstat_fr = Column('gstat_fr', Unicode)
    gstat_it = Column('gstat_it', Unicode)
    gkat = Column('gkat', SmallInteger)
    gkat_de = Column('gkat_de', Unicode)
    gkat_fr = Column('gkat_fr', Unicode)
    gkat_it = Column('gkat_it', Unicode)
    gklas = Column('gklas', SmallInteger)
    gklas_de = Column('gklas_de', Unicode)
    gklas_fr = Column('gklas_fr', Unicode)
    gklas_it = Column('gklas_it', Unicode)
    gbauj = Column('gbauj', SmallInteger)
    gbaum = Column('gbaum', SmallInteger)
    gbaup = Column('gbaup', SmallInteger)
    gbaup_de = Column('gbaup_de', Unicode)
    gbaup_fr = Column('gbaup_fr', Unicode)
    gbaup_it = Column('gbaup_it', Unicode)
    gabbj = Column('gabbj', SmallInteger)
    garea = Column('garea', Integer)
    gvol = Column('gvol', Integer)
    gvolnorm = Column('gvolnorm', SmallInteger)
    gvolnorm_de = Column('gvolnorm_de', Unicode)
    gvolnorm_fr = Column('gvolnorm_fr', Unicode)
    gvolnorm_it = Column('gvolnorm_it', Unicode)
    gvolsce = Column('gvolsce', SmallInteger)
    gvolsce_de = Column('gvolsce_de', Unicode)
    gvolsce_fr = Column('gvolsce_fr', Unicode)
    gvolsce_it = Column('gvolsce_it', Unicode)
    gastw = Column('gastw', SmallInteger)
    ganzwhg = Column('ganzwhg', SmallInteger)
    gazzi = Column('gazzi', SmallInteger)
    gschutzr = Column('gschutzr', SmallInteger)
    gebf = Column('gebf', SmallInteger)
    gwaerzh1 = Column('gwaerzh1', SmallInteger)
    gwaerzh1_de = Column('gwaerzh1_de', Unicode)
    gwaerzh1_fr = Column('gwaerzh1_fr', Unicode)
    gwaerzh1_it = Column('gwaerzh1_it', Unicode)
    genh1 = Column('genh1', SmallInteger)
    genh1_de = Column('genh1_de', Unicode)
    genh1_fr = Column('genh1_fr', Unicode)
    genh1_it = Column('genh1_it', Unicode)
    gwaersceh1 = Column('gwaersceh1', SmallInteger)
    ...
    gwaerdath1 = Column('gwaerdath1', DateTimeChsdi)
    gwaerzh2 = Column('gwaerzh2', SmallInteger)
    gwaerzh2_de = Column('gwaerzh2_de', Unicode)
    gwaerzh2_fr = Column('gwaerzh2_fr', Unicode)
    gwaerzh2_it = Column('gwaerzh2_it', Unicode)
    genh2 = Column('genh2', SmallInteger)
    genh2_de = Column('genh2_de', Unicode)
    genh2_fr = Column('genh2_fr', Unicode)
    genh2_it = Column('genh2_it', Unicode)
    gwaersceh2 = Column('gwaersceh2', SmallInteger)
    gwaersceh2_de = Column('gwaersceh2_de', Unicode)
    gwaersceh2_fr = Column('gwaersceh2_fr', Unicode)
    gwaersceh2_it = Column('gwaersceh2_it', Unicode)
    gwaerdath2 = Column('gwaerdath2', DateTimeChsdi)
    gwaerzw1 = Column('gwaerzw1', SmallInteger)
    gwaerzw1_de = Column('gwaerzw1_de', Unicode)
    gwaerzw1_fr = Column('gwaerzw1_fr', Unicode)
    gwaerzw1_it = Column('gwaerzw1_it', Unicode)
    genw1 = Column('genw1', SmallInteger)
    genw1_de = Column('genw1_de', Unicode)
    genw1_fr = Column('genw1_fr', Unicode)
    genw1_it = Column('genw1_it', Unicode)
    gwaerscew1 = Column('gwaerscew1', SmallInteger)
    gwaerscew1_de = Column('gwaerscew1_de', Unicode)
    gwaerscew1_fr = Column('gwaerscew1_fr', Unicode)
    gwaerscew1_it = Column('gwaerscew1_it', Unicode)
    gwaerdatw1 = Column('gwaerdatw1', DateTimeChsdi)
    gwaerzw2 = Column('gwaerzw2', SmallInteger)
    gwaerzw2_de = Column('gwaerzw2_de', Unicode)
    gwaerzw2_fr = Column('gwaerzw2_fr', Unicode)
    gwaerzw2_it = Column('gwaerzw2_it', Unicode)
    genw2 = Column('genw2', SmallInteger)
    genw2_de = Column('genw2_de', Unicode)
    genw2_fr = Column('genw2_fr', Unicode)
    genw2_it = Column('genw2_it', Unicode)
    gwaerscew2 = Column('gwaerscew2', SmallInteger)
    gwaerscew2_de = Column('gwaerscew2_de', Unicode)
    gwaerscew2_fr = Column('gwaerscew2_fr', Unicode)
    gwaerscew2_it = Column('gwaerscew2_it', Unicode)
    gwaerdatw2 = Column('gwaerdatw2', DateTimeChsdi)
    ...
    wstwk_de = Column('wstwk_de', Unicode)
    wstwk_fr = Column('wstwk_fr', Unicode)
    wstwk_it = Column('wstwk_it', Unicode)
    wmehrg = Column('wmehrg', SmallInteger)
    weinr = Column('weinr', Unicode)
    wbez = Column('wbez', Unicode)
    wstat = Column('wstat', SmallInteger)
    wstat_de = Column('wstat_de', Unicode)
    wstat_fr = Column('wstat_fr', Unicode)
    wstat_it = Column('wstat_it', Unicode)
    wexpdat = Column('wexpdat', DateTime)
    ltyp = Column('ltyp', SmallInteger)
    ltyp_de = Column('ltyp_de', Unicode)
    ltyp_fr = Column('ltyp_fr', Unicode)
    ltyp_it = Column('ltyp_it', Unicode)
    wbauj = Column('wbauj', SmallInteger)
    wabbj = Column('wabbj', SmallInteger)
    warea = Column('warea', SmallInteger)
...
class Arealstatistik(Base, Vector):
    ...
    desc_as_72_rm = Column('desc_as_72_rm', Integer)
