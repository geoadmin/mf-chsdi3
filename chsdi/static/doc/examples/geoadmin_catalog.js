...
$(document).ready(function(){
  ...
  $.getJSON("http://api3.geo.admin.ch/rest/services/inspire/CatalogServer?lang=de", function(data) {
    var firstLevelCat;
    ...
    $.getJSON("http://api3.geo.admin.ch/rest/services/inspire/MapServer?lang=de", function(data){
      var listOfLayers = [];
