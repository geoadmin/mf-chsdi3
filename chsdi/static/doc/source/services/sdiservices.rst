...
For the testing phase, the service is free for use. See conditions `conditions <https://www.swisstopo.ch>`_ give us feedback via our `survey <https://findmind.ch/c/vectortilesEN>`_  
