...
'''''''''''''''''''''''''''''
- Bug fixes
- Announcement: the layer ch.bazl.luftfahrthindernis will change its data model with the FSDI Release on May 18th 2022: Attributes to be removed: abortionaccomplished, bbox, coordinates, duration, lk100, sanctiontext, startofconstruction, totallength. Attributes to be added: airport, effectivedate, group, lighting, marking, radius, uuid. Full new KML `model description <https://data.geo.admin.ch/ch.bazl.luftfahrthindernis/ch.bazl.luftfahrthindernis_specification_20220309.pdf>`__
