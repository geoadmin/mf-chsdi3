...
%>
    ...
    <tr><td class="cell-left">${_('link_to_sonnendach')}</td>                                               <td><a href="http://www.energiestadtfinder.ch/sonnendach/?featureId=${c['featureId']}&lang=${lang}" target="_blank">${_('sonnendach_link')}</a></td></tr>
</%def>
