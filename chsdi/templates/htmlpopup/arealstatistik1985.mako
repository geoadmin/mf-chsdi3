...
<% c['stable_id'] = True %>
    ...
    <tr><td class="cell-left-large">${mod_translate.Translator.translate('id_arealstatistik_85', lang)}</td>   <td>${c['attributes']['id_arealstatistik'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${mod_translate.Translator.translate('fj97', lang)}</td>                   <td>${c['attributes']['fj97'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${mod_translate.Translator.translate('id_arealstatistik_97', lang)}</td>   <td>${c['attributes']['id_arealstatistik_97'] or '-'}</td></tr>
</%def>
