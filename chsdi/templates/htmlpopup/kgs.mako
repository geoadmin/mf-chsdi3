...
<%def name="extended_info(c, lang)">
    <%
        ...
        csv_url = dataGeoAdminHostProtocol + "://" + dataGeoAdminHost + "/" + c['layerBodId']  + "/image/meta.txt"
        csv_file = None
    ...
    % if c['attributes']['pdf_list'] not in [None, ""]:
        <tr>
	        ...
	        % for pdf in c['attributes']['pdf_list'].split(','):
                <a href="${dataGeoAdminHostProtocol}://${dataGeoAdminHost}/ch.babs.kulturgueter/PDF/${pdf}" target="_blank">${pdf}</a><br />
	        % endfor
            </td>
	    </tr>
    %endif
    ...
    % endif
     ...
     <div id="blueimp-gallery" class="blueimp-gallery blueimp-gallery-controls">
        ...
        <div class="kgs-thumbnails">
            ...
            %for pic in pic_list:
                <div class="thumbnail">
                    <a href="${dataGeoAdminHostProtocol}://${dataGeoAdminHost}/ch.babs.kulturgueter/image/kgs_${pic[0]}_${pic[1]}.jpg">
                        <img class="image" src="${dataGeoAdminHostProtocol}://${dataGeoAdminHost}/ch.babs.kulturgueter/image/kgs_${pic[0]}_${pic[1]}.jpg" />
                    </a>
