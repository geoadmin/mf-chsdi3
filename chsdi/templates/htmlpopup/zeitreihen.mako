...
<%def name="table_body(c,lang)">
  ...
  %>
  <tr>
    <td class="cell-left">${mod_translate.Translator.translate('kartenwerk', lang)}</td>
    <td>${mod_translate.Translator.translate(productName, lang)}</td>
  </tr>
  <tr>
    <td class="cell-left">${mod_translate.Translator.translate('kbnum', lang)}</td>
    <td>${c['attributes']['kbnum'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-left">${mod_translate.Translator.translate('kbbez', lang)}</td>
    <td>${c['attributes']['kbbez'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-left">${mod_translate.Translator.translate('release_year', lang)}</td>
    <td>${c['attributes']['release_year'] or '-'}</td></tr>
  <tr>
    <td class="cell-left">${mod_translate.Translator.translate('blattbezeichnung', lang)}</td>
...
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('tt_zeitreihen_FullResView', lang)}</td>
  <td>
    <a href="${viewer_url}" target="_blank" title="${mod_translate.Translator.translate('tt_zeitreihen_FullResView', lang)} - ${c['attributes']['kbbez']} - ${c['attributes']['kbnum']} - ${c['attributes']['release_year']} - ${c['attributes']['bv_nummer']}"><img src="${preview_url}" alt="${mod_translate.Translator.translate('tt_zeitreihen_FullResView', lang)} - ${c['attributes']['kbbez']} - ${c['attributes']['release_year']} - ${c['attributes']['bv_nummer']}"></a>
  </td>
</tr>
% else:
<tr>
