...
<%def name="table_body(c,lang)">
  ...
  <tr>
    <td class="cell-left">${t.Translator.translate('kbbez', lang)}</td>
    <td>${c['attributes']['kbbez'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-left">${t.Translator.translate('release_year', lang)}</td>
    <td>${c['attributes']['release_year'] or '-'}</td></tr>
  <tr>
    <td class="cell-left">${t.Translator.translate('blattbezeichnung', lang)}</td>
