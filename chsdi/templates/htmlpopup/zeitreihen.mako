...
<%def name="table_body(c,lang)">
  ...
  %>
  <tr>
    <td class="cell-left">${h.translate('kartenwerk', lang)}</td>
    <td>${h.translate(productName, lang)}</td>
  </tr>
  <tr>
    <td class="cell-left">${h.translate('kbnum', lang)}</td>
    <td>${c['attributes']['kbnum'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-left">${h.translate('kbbez', lang)}</td>
    <td>${c['attributes']['kbbez'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-left">${h.translate('release_year', lang)}</td>
    <td>${c['attributes']['release_year'] or '-'}</td></tr>
  <tr>
    <td class="cell-left">${h.translate('blattbezeichnung', lang)}</td>
...
<tr>
  <td class="cell-left">${h.translate('tt_zeitreihen_FullResView', lang)}</td>
  <td>
    <a href="${viewer_url}" target="_blank" title="${h.translate('tt_zeitreihen_FullResView', lang)} - ${c['attributes']['kbbez']} - ${c['attributes']['kbnum']} - ${c['attributes']['release_year']} - ${c['attributes']['bv_nummer']}"><img src="${preview_url}" alt="${h.translate('tt_zeitreihen_FullResView', lang)} - ${c['attributes']['kbbez']} - ${c['attributes']['release_year']} - ${c['attributes']['bv_nummer']}"></a>
  </td>
</tr>
% else:
<tr>
