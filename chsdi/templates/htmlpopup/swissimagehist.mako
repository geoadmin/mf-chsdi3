...
<%def name="table_body(c, lang)">
    ...
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.swissimage-product.metadata.colormode', lang)}</td>            <td>${t.Translator.translate(c['attributes']['colormode'] or '-', lang)}</td></tr>
</%def>
