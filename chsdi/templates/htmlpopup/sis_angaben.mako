...
%>
    ...
    <tr><td class="cell-left">${t.translate('tt_sachplan-infrastruktur-schiene_aus_anlageart', lang)}</td>      <td>${c['attributes'][facility_kind] or '-'}</td></tr>
    <tr><td class="cell-left">${t.translate('tt_ch.bfe.energieforschung_projektstatus', lang)}</td>             <td>${c['attributes'][facility_status] or '-'}</td></tr>
