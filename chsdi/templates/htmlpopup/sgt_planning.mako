...
<%
    ...
    web = 'web_%s' % lang
%>
    <tr><td class="cell-left">${t.Translator.translate('ch.bfe.sachplan-geologie-tiefenlager.pmname', lang)}</td>           <td>${c['attributes'][pmname] or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bfe.sachplan-geologie-tiefenlager.pmkind', lang)}</td>           <td>${c['attributes'][pmkind] or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bfe.sachplan-geologie-tiefenlager.coordlevel', lang)}</td>       <td>${c['attributes'][coordlevel] or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bfe.sachplan-geologie-tiefenlager.planningstatus', lang)}</td>   <td>${c['attributes'][planningstatus] or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bfe.sachplan-geologie-tiefenlager.validfrom', lang)}</td>        <td>${c['attributes']['validfrom'] or '-'}</td></tr>
