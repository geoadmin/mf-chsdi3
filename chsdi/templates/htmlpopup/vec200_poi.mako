...
<%def name="table_body(c,lang)">
    ...
    <tr><td class="cell-left">${Translator.translate('typ_kraftwerk')}</td><td>${_(c['attributes']['ppc'] or '-', lang)}</td></tr>
    % endif

    % if c['attributes']['objval'].strip() in ['Verarbeitungsanlage','Deponie','Pumpwerk']:
    <tr><td class="cell-left">${Translator.translate('typ_produkt')}</td><td>${_(c['attributes']['pro'] or '-', lang)}</td></tr>
    % endif
</%def>
