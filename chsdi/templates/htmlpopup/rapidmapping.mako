...
%>
    ...
    <tr><td class="cell-left">${_('ch.swisstopo.rapidmapping.link_to_event')}</td>         <td><a href="${c['attributes']['link_to_event']}" target="_blank">Link</a></td></tr>
<tr><td class="cell-left">${_('ch.swisstopo.rapidmapping.downloads')}</td>         <td><a href="${c['attributes']['link_to_data']}" target="_blank">Event index</a> | <a href="${c['attributes']['download_img']}" target="_blank">.tif</a> | <a href="${c['attributes']['download_tfw']}" target="_blank">.tfw</a> | <a href="${c['attributes']['download_ovr']}" target="_blank">.ovr</a></td></tr>
</%def>
