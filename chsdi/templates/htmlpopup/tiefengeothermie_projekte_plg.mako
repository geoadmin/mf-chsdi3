...
<%def name="extended_info(c,lang)">
  ...
  <table class="table-with-border tiefengeothermie_projekte-extended">
    ...
    <tr>
      <th class="cell-left">${_('ch.swisstopo.geologie-tiefengeothermie_projekte.permis')}</th>
      <td>${c['attributes'][permis_text] or '-'}</td>
    </tr>
    <tr>
      <th class="cell-left">${_('ch.swisstopo.geologie-tiefengeothermie_projekte.date')}</th>
