...
-->
	<tr><td class="cell-left">${t.Translator.translate('status_fp', lang)}</td>      <td>${c['attributes']['status'] or '-'}</td></tr>
	<tr><td class="cell-left">${t.Translator.translate('fp_Y03_X03', lang)}</td>     <td>${c['attributes']['y03'] or '-'} / ${c['attributes']['x03'] or '-'}</td></tr>
	<tr><td class="cell-left">${t.Translator.translate('fp_E95_N95', lang)}</td>     <td>${c['attributes']['e95'] or '-'} / ${c['attributes']['n95'] or '-'}</td></tr>
	<tr><td class="cell-left">${t.Translator.translate('fp_H02', lang)}</td>         <td>${c['attributes']['h02'] or '-'}</td></tr>
<!--	
