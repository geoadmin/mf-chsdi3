...
<%def name="table_body(c, lang)">
	...
	<tr><td class="cell-left">${_(c['layerBodId']+'.koordinate')}</td>      		<td>${fengshui_coord(c['attributes']['koordinate'])}</td></tr>
	<tr><td class="cell-left">${_(c['layerBodId']+'.hoehe_geom_m')}</td>      		<td>${'{0:.3f}'.format(c['attributes']['hoehe_geom_m']) or '-'}</td></tr>
