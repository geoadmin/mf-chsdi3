...
<%def name="table_body(c, lang)">
    ...
    <tr>
        <td class="cell-left">${_('ch.pronatura.waldreservate.gisflaeche')}</td>
    ...
    <tr>
        <td class="cell-left">${_('ch.pronatura.waldreservate.obj_gesflaeche')}</td>
        % if c['attributes']['gesflaeche']:
    ...
    <tr>
        <td class="cell-left">${_('ch.pronatura.waldreservate.gisteilobjekt')}</td>
    ...
    <tr><td class="cell-left">${_('ch.pronatura.waldreservate.mcpfe')}</td><td>${c['attributes'][class_text] or '-'}</td></tr>
