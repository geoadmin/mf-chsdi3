...
<%def name="table_body(c, lang)">
    ...
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.content')}</td><td>${c['attributes']['content'] or '-'}</td></tr>
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.remarks')}</td><td>${c['attributes']['remarks'] or '-'}</td></tr>
    ...
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.de_link_portal')}</td><td><a  target="_blank" href=${c['attributes'][link_portal] or '-'}>link to portal</a></td></tr>
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.de_link_description')}</td><td><a  target="_blank" href=${c['attributes'][link_description] or '-'}>link to description</a></td></tr>
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.de_link_documentation')}</td><td><a  target="_blank" href=${c['attributes'][link_documentation] or '-'}>link to documentation</a></td></tr>
</%def>
