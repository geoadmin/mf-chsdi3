...
<%def name="table_body(c, lang)">
    ...
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.de_link_portal')}</td><td>${c['attributes'][link_portal] or '-'}</td></tr>
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.de_link_description')}</td><td>${c['attributes'][link_description] or '-'}</td></tr>
    <tr><td class="cell-left">${_('ch.swisstopo.geologie-geologische_3dmodelle.de_link_documentation')}</td><td>${c['attributes'][link_documentation] or '-'}</td></tr>
</%def>
