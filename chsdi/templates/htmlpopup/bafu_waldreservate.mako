...
<%def name="table_body(c, lang)">
    <tr><td class="cell-left">${t.Translator.translate('ch.bafu.waldreservate.objnummer', lang)}</td>                    <td>${c['attributes']['objnummer'] or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bafu.waldreservate.name', lang)}</td>                         <td>${c['attributes']['name'] or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bafu.waldreservate.gisflaeche', lang)}</td>                   <td>${round(c['attributes']['gisflaeche'],2) or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bafu.waldreservate.obj_gesflaeche', lang)}</td>
