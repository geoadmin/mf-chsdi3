...
<%
    ...
    web = 'web_%s' % lang
%>
    <tr><td class="cell-left">${h.translate('ch.bfe.sachplan-geologie-tiefenlager.facptname', lang)}</td>              <td>${c['attributes'][facptname] or '-'}</td></tr>
    <tr><td class="cell-left">${h.translate('ch.bfe.sachplan-geologie-tiefenlager.fackind', lang)}</td>                <td>${c['attributes'][fackind] or '-'}</td></tr>
