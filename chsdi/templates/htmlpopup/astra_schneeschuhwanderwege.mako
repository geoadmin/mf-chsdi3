...
<% c['stable_id'] = False %>
   ...
   <tr><td class="cell-left">${_('ch.astra.schneeschuhwanderwege.laenger')}</td>                    <td>${c['attributes']['laenger']  or '-'}</td></tr>
   <tr><td class="cell-left">${_('ch.astra.schneeschuhwanderwege.hoeheaufr')}</td>                  <td>${c['attributes']['hoeheaufr']  or '-'}</td></tr>
   <tr><td class="cell-left">${_('ch.astra.schneeschuhwanderwege.hoeheabr')}</td>                   <td>${c['attributes']['hoeheabr']  or '-'}</td></tr>
   <tr><td class="cell-left">${_('ch.astra.schneeschuhwanderwege.zeitstzir')}</td>                  <td>${c['attributes']['zeitstzir']  or '-'}</td></tr>
