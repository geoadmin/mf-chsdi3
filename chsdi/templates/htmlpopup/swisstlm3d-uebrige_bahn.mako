...
%>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-uebrigerverkehr.objektart', lang)}</td>
      <td>${_(objektart_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-uebrigerverkehr.name', lang)}</td>
      <td>${_(c['attributes']['name']) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-uebrigerverkehr.ausser_betrieb', lang)}</td>
