...
%>
    ...
    <tr><td class="cell-left">${_('ch.astra.wanderland-sperrungen_umleitungen.file')}</td>                     <td>${c['attributes']['sperrung_file'] or '-'}</td></tr>
...
% if c['attributes'][url1_link]:
    <tr><td class="cell-left">${_('ch.astra.wanderland-sperrungen_umleitungen.url1_link')}</td>                <td><a href="${c['attributes'][url1_link]}" target="_blank">${c['attributes'][url1_text]}</a></td></tr>
%  else:
