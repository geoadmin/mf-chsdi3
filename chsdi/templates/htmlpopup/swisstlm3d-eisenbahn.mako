...
%>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-eisenbahnnetz.objektart', lang)}</td>
      <td>${_(objektart_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-eisenbahnnetz.verkehrsmittel', lang)}</td>
      <td>${_(verkehrsmittel_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-eisenbahnnetz.standseilbahn', lang)}</td>
      <td>${_(standseilbahn_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-eisenbahnnetz.zahnradbahn', lang)}</td>
      <td>${_(zahnradbahn_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${h.translate('ch.swisstopo.swisstlm3d-eisenbahnnetz.ausser_betrieb', lang)}</td>
