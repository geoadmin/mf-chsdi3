...
<tr><td class="cell-left">${_('ch.swisstopo.geologie-gletschermaechtigkeit.mean_thik')}</td><td>${int(c['attributes']['mean_thick']) or '-'}</td></tr>
<tr><td class="cell-left">${_('ch.swisstopo.geologie-gletschermaechtigkeit.max_thik')}</td><td>${int(c['attributes']['max_thick']) or '-'}</td></tr>
