...
<%def name="table_body(c,lang)">
       ...
       <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.geologie-rohstoffe-industrieminerale.obname', lang)}</td><td>${c['attributes']['obname'] or '-'}</td></tr>
       <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.geologie-rohstoffe-industrieminerale.obnamealt', lang)}</td><td>${c['attributes']['obnamealt'] or '-'}</td></tr>
       <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.geologie-rohstoffe-industrieminerale.imkinds', lang)}</td><td>${c['attributes']['imkinds'] or '-'}</td></tr>
