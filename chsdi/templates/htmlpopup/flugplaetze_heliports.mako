...
<%def name="table_body(c, lang)">
    ...
    <tr><td class="cell-left">${_('ch.bazl.flugplaetze-heliports.arp_east')}</td>         <td>${int(round(c['attributes']['arp_east'])) or '-'}</td></tr>
    <tr><td class="cell-left">${_('ch.bazl.flugplaetze-heliports.arp_north')}</td>         <td>${int(round(c['attributes']['arp_north'])) or '-'}</td></tr>
    <tr><td class="cell-left">${_('ch.bazl.flugplaetze-heliports.elevation')}</td>         <td>${int(round(c['attributes']['elevation'])) or '-'}</td></tr>
</%def>
