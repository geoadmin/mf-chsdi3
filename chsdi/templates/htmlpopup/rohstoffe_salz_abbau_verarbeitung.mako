...
<%def name="table_body(c,lang)">
       ...
       <tr><td class="cell-left">${_('ch.swisstopo.geologie-rohstoffe-salz_abbau_verarbeitung.obnamealt')}</td><td>${c['attributes']['obnamealt'] or '-'}</td></tr>
...
%if c['attributes']['ltkind']:
       <tr><td class="cell-left">${_('ch.swisstopo.geologie-rohstoffe-salz_abbau_verarbeitung.ltkind')}</td><td>${c['attributes']['ltkind'] or '-'}</td></tr>
%endif
