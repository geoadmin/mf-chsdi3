...
%>
    ...
    <tr><td class="cell-left">${t.Translator.translate('ch.bafu.schutzgebiete-paerke_nationaler_bedeutung_perimeter.status', lang)}</td>               <td>${_(status)}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bafu.schutzgebiete-paerke_nationaler_bedeutung_perimeter.kategorie', lang)}</td>            <td>${_(kategorie)}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.bafu.schutzgebiete-paerke_nationaler_bedeutung_perimeter.rechtsgrundlage', lang)}</td>      <td>${_(rechtsgrundlage)}</td></tr>
