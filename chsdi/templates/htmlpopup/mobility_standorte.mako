...
%>
    ...
    <tr><td class="cell-left">${_('ch.mobility.standorte.link')}</td>           <td><a target="_blank" href="https://www.mobility.ch/${lang}/return/stations/?stationQuery=${c['attributes']['number'] or ''}">Link</a></td></tr>
