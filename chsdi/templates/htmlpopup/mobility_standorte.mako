...
%>
    ...
    <tr><td class="cell-left">${_('ch.mobility.standorte.link')}</td>           <td><a target="_blank" href="https://www.mobility.ch/${lang}/?stationQuery=${c['attributes']['name'] or ''}">Link</a></td></tr>
