...
<% c['stable_id'] = True %>
    ...
    <tr><td class="cell-left">${h.translate(zaehlstelle, lang)}</td>            <td>${c['attributes']['zaehlstellen_bezeichnung']}</td></tr>
    <tr><td class="cell-left">${h.translate('physischvirtuell', lang)}</td>     <td>${c['attributes']['zst_physisch_virtuell'] or '-'}</td></tr>
    <tr><td class="cell-left">${h.translate('messstellentyp', lang)}</td>       <td>${c['attributes']['messstellentyp'] or '-'}</td></tr>
</%def>
