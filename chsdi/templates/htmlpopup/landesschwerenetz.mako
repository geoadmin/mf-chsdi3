...
%>
    ...
    <tr>
        <td class="cell-left">${_('ch.swisstopo.landesschwerenetz.lat_etrs')}</td>
        % if c['attributes']['lat_etrs']:
            <td>${round(c['attributes']['lat_etrs'], 3)}</td>
        % else:
            <td>-</td>
        % endif
    </tr>
    <tr>
        <td class="cell-left">${_('ch.swisstopo.landesschwerenetz.lon_etrs')}</td>
        % if c['attributes']['lon_etrs']:
            <td>${round(c['attributes']['lon_etrs'], 3)}</td>
        % else:
            <td>-</td>
        % endif
    </tr>
    <tr>
        <td class="cell-left">${_('ch.swisstopo.landesschwerenetz.y_lv95')}</td>
        % if c['attributes']['y_lv95']:
            <td>${int(round(c['attributes']['y_lv95']))}</td>
        % else:
            <td>-</td>
        % endif
    </tr>
    <tr>
        <td class="cell-left">${_('ch.swisstopo.landesschwerenetz.x_lv95')}</td>
        % if c['attributes']['x_lv95']:
            <td>${int(round(c['attributes']['x_lv95']))}</td>
        % else:
            <td>-</td>
        % endif
    </tr>
    ...
    % if "http" in str(c['attributes'].get('link_hfp_url', '-')):
    ...
    % if "http" in str(c['attributes'].get('link_lfp_url', '-')):
