...
<tr><td class="cell-left">${_('ch.bafu.hydrologie-niedrigwasserstatistik.url_nqpdf')}</td>      <td><a href="${c['attributes']['url_nqpdf'] or '-'}" target="_blank">${c['attributes']['url_nqpdf'] or '-'}</a></td></tr>
