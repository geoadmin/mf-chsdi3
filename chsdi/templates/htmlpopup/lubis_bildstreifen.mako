...
<% c['stable_id'] = True %>
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.lubis-bildstreifen.id', lang)}</td>          <td>${c['featureId']}</td></tr>
...
<body onload="init()">
    ...
    <table class="table-with-border kernkraftwerke-extended">
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_lineId', lang)}</th>              <td>${c['featureId']}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_Flugdatum', lang)}</th>           <td>${c['attributes']['flugdatum']}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_auflosung', lang)}</th>           <td>${c['attributes']['resolution']}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_y1', lang)}</th>                  <td>${c['attributes']['toposhop_start_x'] or '-'}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_x1', lang)}</th>                  <td>${c['attributes']['toposhop_start_y'] or '-'}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_y2', lang)}</th>                  <td>${c['attributes']['toposhop_end_x'] or '-'}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_x2', lang)}</th>                  <td>${c['attributes']['toposhop_end_y'] or '-'}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_linielaenge', lang)}</th>         <td>${c['attributes']['toposhop_length'] or '-'}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_project', lang)}</th>             <td>${c['attributes']['goal'] or '-'}</td></tr>
        <tr><th class="cell-left">${t.Translator.translate('tt_lubis_source_georef', lang)}</th>       <td>${c['attributes']['source_georef'] or '-'}</td></tr>
% if   c['attributes']['gsd'] == 0.25 or c['attributes']['gsd'] == 0.5 or round(c['attributes']['gsd'],1) == 0.1:
        <tr><th class="cell-left">${t.Translator.translate('link', lang)} Online Shop</th>
