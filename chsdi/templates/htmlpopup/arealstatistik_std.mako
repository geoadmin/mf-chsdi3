...
%>
    ...
    <tr><td class="cell-left-large">${t.Translator.translate('id_arealstatistik_85', lang)}</td>   <td>${t.Translator.translate(Key_To_Translate_85, lang)}</td></tr>
    <tr><td class="cell-left-large">${t.Translator.translate('fj97', lang)}</td>                   <td>${c['attributes']['fj97'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${t.Translator.translate('id_arealstatistik_97', lang)}</td>   <td>${t.Translator.translate(Key_To_Translate_97, lang)}</td></tr>
    <tr><td class="cell-left-large">${t.Translator.translate('fj09', lang)}</td>                   <td>${c['attributes']['fj09'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${t.Translator.translate('id_arealstatistik_09', lang)}</td>   <td>${t.Translator.translate(Key_To_Translate_09, lang)}</td></tr>
</%def>
