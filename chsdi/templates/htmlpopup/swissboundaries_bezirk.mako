...
%>
<% c['stable_id'] = True %>
<tr><td class="cell-left">${h.translate('bfsnr', lang)}</td><td>${int(round(c['featureId'])) or '-'}</td></tr>
<tr><td class="cell-left">${h.translate('ch.swisstopo.swissboundaries3d-bezirk-flaeche.fill.name', lang)}</td><td>${c['attributes']['name']}</td></tr>
