...
%>
    ...
    <table class="wind-bund-extended">
       <tr class="wind_info">
            <td colspan="2"><p>${t.Translator.translate('ch.are.windenergie-bundesinteressen.tt_info', lang)}</p></td>
       </tr>
       <tr class="wind_legend">
           <td><div class="wind_kbik_main wind_kbik_2"></div><p>${t.Translator.translate('ch.are.windenergie-bundesinteressen.bik2', lang)}</p></td>
           <td class="wind_legend"><p>${desc_bik2}</p></td>
       </tr>
       <tr class="wind_legend">
           <td><div class="wind_kbik_main wind_kbik_3"></div><p>${t.Translator.translate('ch.are.windenergie-bundesinteressen.bik3', lang)}</p></td>
           <td><p>${desc_bik3}</p></td>
       </tr>
       <tr class="wind_legend">
           <td><div class="wind_kbik_main wind_kbik_4"></div><p>${t.Translator.translate('ch.are.windenergie-bundesinteressen.bik4', lang)}</p></td>
           <td><p>${desc_bik4}</p></td>
       </tr>
       <tr class="wind_legend">
