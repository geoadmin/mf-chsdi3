...
%endif
  ...
  % if c['attributes']['standard']=='sbns_area' :
    % if lang=='it' :
    ...
    <tr><img class="image" src="https://api3.geo.admin.ch/featureattachments/ch.bfe.energiestaedte-nachhaltige_areale/svg/snbs_quartier.svg" alt=""/></tr>
     %endif
  % elif c['attributes']['standard']=='minergie_area' :
    <tr><img class="image" src="https://api3.geo.admin.ch/featureattachments/ch.bfe.energiestaedte-nachhaltige_areale/svg/minergie_area_" + ${_(lang)}  + ".svg" alt=""/></tr>
  % else :
