...
<%def name="kehrichtverbrennungsanlagen_waerme_graph(data)">
    ...
    <div id="kehrichtverbrennungsanlagen_waerme_graph">
        <label>${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.diagramm_waerme', lang)}</label>
...
<%def name="kehrichtverbrennungsanlagen_strom_graph(data)">
    ...
    <div id="kehrichtverbrennungsanlagen_strom_graph">
        <label>${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.diagramm_strom', lang)}</label>
...
<%def name="table_body(c, lang)">
    ...
    <tr>
        <td class="cell-left">${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.name', lang)}</td>
        <td>${c['attributes']['name'] or '-'}</td>
    </tr>
    <tr>
        <td class="cell-left">${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.place', lang)}</td>
        <td>${c['attributes']['place'] or '-'}</td>
    </tr>
%if c['attributes']['web']:
    <tr>
        <td>${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.web', lang)}</td>
...
%endif
    <tr>
        <td class="cell-left">${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.beginning_of_operation', lang)}</td>
...
<%def name="extended_info(c, lang)">
    ...
    <table class="table-with-border">
        ...
        <tr>
            <th class="cell-left">${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.place', lang)}</th>
            <td>${c['attributes']['place'] or '-'}</td>
        </tr>
    %if c['attributes']['web']:
        <tr>
            <th class="cell-left">${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.web', lang)}</th>
            <td>
    ...
    %endif
        <tr>
            <th class="cell-left">${Translator.translate('ch.bfe.kehrichtverbrennungsanlagen.beginning_of_operation', lang)}</th>
            <td>${c['attributes']['beginningofoperation'] or '-'}</td>
        </tr>
        <tr>
            <td colspan="2">${kehrichtverbrennungsanlagen_waerme_graph(c['attributes'])}</td>
