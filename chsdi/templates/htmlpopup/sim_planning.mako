...
%>
    <tr>
      <td class="cell-left">${t.translate('tt_sachplan_planning_name', lang)}</td>
...
% if c['attributes']['doc_web']:
    <tr>
      ...
      <td><a href="${c['attributes']['doc_web'] or '-'}" target="_blank">${t.translate('tt_sachplan_objektblatt', lang)}</a></td></tr>
% else:
    <tr>
      <td class="cell-left">${t.translate('tt_sachplan_weitereinfo', lang)}</td>
      <td> - </td>
