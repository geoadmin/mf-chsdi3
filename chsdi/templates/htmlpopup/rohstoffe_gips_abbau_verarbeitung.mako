...
%endif
       ...
       <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.geologie-rohstoffe-gips_abbau_verarbeitung.purl')}</td><td><a target="_blank" href=${c['attributes']['purl'] or '-'}>${_('layer_url_portal_text', lang)}</a></td></tr>
</%def>
