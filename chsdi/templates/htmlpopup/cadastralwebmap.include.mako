<%def name="table_body_cadastral(c, lang, fallbackLang, clickCoord)">
    ...
    % elif c['attributes']['ak'] == 'GE':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://ge.ch/carte/pro/?mapresources=CADASTRE&extent=${c['bbox'][0]},${c['bbox'][1]},${c['bbox'][2]},${c['bbox'][3]}" target="_blank">GE</a></td></tr>
    ...
    % elif c['attributes']['ak'] == 'SO':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://geoweb.so.ch/map/grundbuchplan-nf?startExtent=${','.join(map(str, c['bbox']))}" target="_blank">SO</a></td></tr>
    ...
    % elif c['attributes']['ak'] == 'BL':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://geoview.bl.ch/?map_x=2${c['clickCoordLv03'][0]}&map_y=1${c['clickCoordLv03'][1]}&map_zoom=9" target="_blank">BL</a></td></tr>
