<%def name="table_body_cadastral(c, lang, fallbackLang)">
    ...
    % elif c['attributes']['ak'] == 'AG':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="https://www.ag.ch/app/agisviewer4/v1/html/agisviewer.htm?config=agis_geoportal_fs.json&basemap=base_landeskarten_sw&thema=176&xmin=${c['bboxlv03'][0]}&ymin=${c['bboxlv03'][1]}&xmax=${c['bboxlv03'][2]}&ymax=${c['bboxlv03'][3]}" target="_blank">AG</a></td></tr>
    % elif c['attributes']['ak'] == 'BS':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://www.stadtplan.bs.ch/geoviewer/index.php?theme=258&extent=${','.join(map(str,c['bboxlv03']))}&layers=parzplan_vektor_grau_1000,av_parzellen_labels" target="_blank">BS</a></td></tr>
    % elif c['attributes']['ak'] == 'BE':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://webmap.be-geo.ch/geodaten.php?lang=${lang}&recenter_bbox=${','.join(map(str,c['bboxlv03']))}" target="_blank">BE</a></td></tr>
    % elif c['attributes']['ak'] == 'FR':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://map.geo.fr.ch/?dataTheme=Mensuration officielle&extent=${','.join(map(str,c['bboxlv03']))}&lang=${fallbackLang}" target="_blank">FR</a></td></tr>
    ...
    % elif c['attributes']['ak'] == 'NW':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://map.gis-daten.ch/nw_oereb?xmin=${c['bboxlv03'][0]}&ymin=${c['bboxlv03'][1]}&xmax=${c['bboxlv03'][2]}&ymax=${c['bboxlv03'][3]}" target="_blank">NW</a></td></tr>
    ...
    % elif c['attributes']['ak'] == 'ZH':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://maps.zh.ch/?topic=AVfarbigwwwZH&scale=${c['scale']}&x=${c['clickCoordLv95'][0]}&y=${c['clickCoordLv95'][1]}&offlayers=LCOBJPROJ%2Cbezirkslabels" target="_blank">ZH</a></td></tr>
    % elif c['attributes']['ak'] == 'BL':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="http://geoview.bl.ch/?map_x=${c['clickCoordLv95'][0]}&map_y=${c['clickCoordLv95'][1]}&map_zoom=9" target="_blank">BL</a></td></tr>
    ...
    % elif c['attributes']['ak'] == 'SG':
        <tr><td class="cell-left">${_('link to canton geoportal')}</td><td><a href="https://www.sg.ch/home/bauen__raum___umwelt/aktuelles_energie/Baugesuch/Geoportal.html" target="_blank">SG</a></td></tr>
    ...
    % elif c['attributes']['ak'] == 'FL':
        <tr><td class="cell-left">${_('link to geoportal')}</td><td><a href="http://geodaten.llv.li/geoshop/public.html?zoombox=${c['bboxlv95'][0]},${c['bboxlv95'][1]},${c['bboxlv95'][2]},${c['bboxlv95'][3]}" target="_blank">${_('FL')}</a></td></tr>
    % else:
    ...
    <tr><td class="cell-left">${_('cwm_realestate_type')}</td><td>${_('cwm_realestate_type_{}'.format(c['attributes']['realestate_type']) if c['attributes']['realestate_type'] is not None else 'cwm_realestate_type_default')}</td></tr>
</%def>
