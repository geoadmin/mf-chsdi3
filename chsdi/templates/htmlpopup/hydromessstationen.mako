...
<% c['stable_id'] = True %>
    <tr><td class="cell-left">${t.translate('stationsname', lang)}</td>   <td>${c['attributes']['lhg_name']}</td></tr>
    <tr><td class="cell-left">${t.translate('stationsnr', lang)}</td>     <td>${c['featureId']}</td></tr>
    <tr><td class="cell-left">${t.translate('aktuelle_daten', lang)}</td>
      % if lang in ('de', 'en', 'rm'):
