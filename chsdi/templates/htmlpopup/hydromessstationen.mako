...
<% c['stable_id'] = True %>
    <tr><td class="cell-left">${Translator.translate('stationsname', lang)}</td>   <td>${c['attributes']['lhg_name']}</td></tr>
    <tr><td class="cell-left">${Translator.translate('stationsnr', lang)}</td>     <td>${c['featureId']}</td></tr>
    <tr><td class="cell-left">${Translator.translate('aktuelle_daten', lang)}</td>
      % if lang in ('de', 'en', 'rm'):
