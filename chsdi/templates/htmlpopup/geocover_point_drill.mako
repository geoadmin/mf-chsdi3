...
%>
    ...
    <tr><td class="cell-left">${Translator.translate('geocover_azimut', lang)}</td><td>${c['attributes']['azimut'] or '-'}</td></tr>
    <tr><td class="cell-left">${Translator.translate('geocover_depth_1', lang)}</td><td>${c['attributes']['depth_1'] or '-'}</td></tr>
    <tr><td class="cell-left">${Translator.translate('geocover_description_1', lang)}</td><td>${c['attributes'][description_1] or '-'}</td></tr>
    <tr><td class="cell-left">${Translator.translate('geocover_depth_2', lang)}</td><td>${c['attributes']['depth_2'] or '-'}</td></tr>
    <tr><td class="cell-left">${Translator.translate('geocover_description_2', lang)}</td><td>${c['attributes'][description_2] or '-'}</td></tr>
</%def>
