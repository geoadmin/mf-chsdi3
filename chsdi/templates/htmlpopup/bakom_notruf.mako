...
<%def name="table_body(c, lang)">
    <% c['stable_id'] = True %>
    <tr>
        <td class="cell-left">${_('ch.bakom.notruf.name')}</td>
...
<%def name="extended_info(c, lang)">
    <%
        ...
        arr_fn_addresse_142 = c['attributes']['fn_addresse_142']
        ...
        arr_mo_addresse_142 = c['attributes']['mo_addresse_142']
        ...
        fn_addresse_142 = text_separation(arr_fn_addresse_142)
        ...
        mo_addresse_142 = text_separation(arr_mo_addresse_142)
    ...
    <table class="table-with-border">
        ...
        <tr>
            ...
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_112_festnetz')}</th>
        ...
        <tr>
            ...
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_112_mobil')}</th>
            <td class="cell-meta">${_(mo_addresse_112)|n}</td>
        </tr>
        <tr>
            <th class="cell-meta">${_('ch.bakom.notruf.satellit')}</th>
            <td class="cell-meta">${c['attributes']['satellit_112'] or '-'}</td>
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_112_satellit')}</td>
    ...
    <table class="table-with-border">
        ...
        <tr>
            ...
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_117_festnetz')}</th>
            <td class="cell-meta">${_(fn_addresse_117)|n}</td>
        </tr>
        <tr>
            <th class="cell-meta">${_('ch.bakom.notruf.mobilnetz')}</th>
            <td class="cell-meta">${c['attributes']['mobile_117'] or '-'}</td>
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_117_mobil')}</th>
    ...
    <table class="table-with-border">
        ...
        <tr>
            ...
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_118_festnetz')}</th>
            <td class="cell-meta">${_(fn_addresse_118)|n}</td>
        </tr>
        <tr>
            <th class="cell-meta">${_('ch.bakom.notruf.mobilnetz')}</th>
            <td class="cell-meta">${c['attributes']['mobile_118'] or '-'}</td>
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_118_mobil')}</th>
    ...
    <table class="table-with-border">
        ...
        <tr><th class="cell-meta-one" colspan="4">${142}</th></tr>
        <tr>
            <th class="cell-meta">${_('ch.bakom.notruf.festnetz')}</th>
            <td class="cell-meta">${c['attributes']['festnetz_142'] or '-'}</td>
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_142_festnetz')}</th>
            <td class="cell-meta">${_(fn_addresse_142)|n}</td>
        </tr>
        <tr>
            <th class="cell-meta">${_('ch.bakom.notruf.mobilnetz')}</th>
            <td class="cell-meta">${c['attributes']['mobile_142'] or '-'}</td>
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_142_mobil')}</th>
            <td class="cell-meta">${_(mo_addresse_142)|n}</td>
        </tr>
    </table>
    <tr><td class="cell-meta-one" colspan="2">&nbsp;</td></tr>
    <table class="table-with-border">
        ...
        <tr>
            ...
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_143_festnetz')}</th>
            <td class="cell-meta">${_(fn_addresse_143)|n}</td>
        </tr>
        <tr>
            <th class="cell-meta">${_('ch.bakom.notruf.mobilnetz')}</th>
            <td class="cell-meta">${c['attributes']['mobile_143'] or '-'}</td>
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_143_mobil')}</th>
    ...
    <table class="table-with-border">
        ...
        <tr>
            ...
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_144_festnetz')}</th>
    ...
    <table class="table-with-border">
        ...
        <tr>
            ...
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_147_festnetz')}</th>
            <td class="cell-meta">${_(fn_addresse_147)|n}</td>
        </tr>
        <tr>
            <th class="cell-meta">${_('ch.bakom.notruf.mobilnetz')}</th>
            <td class="cell-meta">${c['attributes']['mobile_147'] or '-'}</td>
            <th class="cell-meta">${_('ch.bakom.notruf.adresse_147_mobil')}</th>
