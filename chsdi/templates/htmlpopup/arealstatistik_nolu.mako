...
<% c['stable_id'] = True %>
    ...
    <tr><td class="cell-left-large">${Translator.translate('id_arealstatistik_lu_85', lang)}</td>    <td>${_(Key_To_Translate_85)}</td></tr>
    <tr><td class="cell-left-large">${Translator.translate('fj97', lang)}</td>                       <td>${c['attributes']['fj97'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${Translator.translate('id_arealstatistik_lu_97', lang)}</td>    <td>${_(Key_To_Translate_97)}</td></tr>
    <tr><td class="cell-left-large">${Translator.translate('fj09', lang)}</td>                       <td>${c['attributes']['fj09'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${Translator.translate('id_arealstatistik_lu_09', lang)}</td>    <td>${_(Key_To_Translate_09)}</td></tr>
</%def>
