...
<% c['stable_id'] = True %>
    ...
    <tr><td class="cell-left-large">${_('id_arealstatistik_lu_85')}</td>    <td>${_(Key_To_Translate_85)}</td></tr>
    <tr><td class="cell-left-large">${_('fj97')}</td>                       <td>${c['attributes']['fj97'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${_('id_arealstatistik_lu_97')}</td>    <td>${_(Key_To_Translate_97)}</td></tr>
    <tr><td class="cell-left-large">${_('fj09')}</td>                       <td>${c['attributes']['fj09'] or '-'}</td></tr>
    <tr><td class="cell-left-large">${_('id_arealstatistik_lu_09')}</td>    <td>${_(Key_To_Translate_09)}</td></tr>
</%def>
