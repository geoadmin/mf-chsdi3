...
%>
    ...
    <tr><td class="cell-left">${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.strname1', lang)} ${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.deinr', lang)}</td>    <td>${c['attributes'][street_key] or '-'} ${c['attributes']['deinr'] or ''}</td></tr>
    % else:
    <tr><td class="cell-left">${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.strname1', lang)} ${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.deinr', lang)}</td>    <td>${c['attributes']['deinr'] or '-'}</td></tr>
    % endif
    <tr><td class="cell-left">${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.plz4', lang)}/${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.plz4', lang)}6</td>        <td>${c['attributes']['plz4'] or '-'}/${c['attributes']['plz6'] or '-'}</td></tr>
    ...
    <tr><td class="cell-left">${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.download', lang)}</td>     <td><a href="${url_canton}"> ${t.Translator.translate('ch.bfs.gebaeude_wohnungs_register.canton_label', lang)}</a></td></tr>
