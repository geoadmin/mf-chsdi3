...
<tr>
  <td class="cell-left">${h.translate('ch.bfe.energiestaedte-2000watt-areale.name', lang)}</td>
  <td>${c['attributes']['name'] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${h.translate('ch.bfe.energiestaedte-2000watt-areale.state', lang)}</td>
  <td>${c['attributes'][bezeichnung_kat] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${h.translate('areal_gemeinde', lang)}</td>
...
<table class="table-with-border kernkraftwerke-extended" cellpadding="5">
  <tr>
    <th class="cell-meta">
     ${h.translate('ch.bfe.energiestaedte-2000watt-areale.name_watt', lang)}
    </th>
    <td>
      ${c['attributes']['name']}
    </td>
  ...
  <tr>
    <th class="cell-meta">
     ${h.translate('ch.bfe.energiestaedte-2000watt-areale.state', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${h.translate('areal_gemeinde', lang)}
    </th>
    <td>
  ...
  % if lang=='fr':
    <th class="cell-meta">
      ${h.translate('faktenblatt', lang)}
    </th>
  % if c['attributes']['linkfaktenblatt_fr'] is None:
    <td class="cell-meta"> - </td>
  % else:
    <td class="cell-meta">
      <a target="_blank" href="${c['attributes']['linkfaktenblatt_fr']}">${h.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
    <th class="cell-meta" colspan="2">
      ${h.translate('kurzerklaerung', lang)}
    </th>
  </tr>
  <tr>
...
<br />
  ...
  % else:
    <td class="cell-meta">
      <a target="_blank" href="${c['attributes']['linkfaktenblatt_it'] or '-'}">${h.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
...
<br />
  ...
  % else:
    <td class="cell-meta">
      <a target="_blank" href="${c['attributes']['linkfaktenblatt_en'] or '-'}">${h.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
...
<br />
  ...
  % else:
    <td class="cell-meta">
      <a target="_blank" href="${c['attributes']['linkfaktenblatt_de'] or '-'}">${h.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
