...
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('ch.bfe.energiestaedte-2000watt-areale.name', lang)}</td>
  <td>${c['attributes']['name'] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('ch.bfe.energiestaedte-2000watt-areale.state', lang)}</td>
  <td>${c['attributes'][bezeichnung_kat] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('areal_gemeinde', lang)}</td>
...
<table class="table-with-border kernkraftwerke-extended" cellpadding="5">
  <tr>
    <th class="cell-meta">
     ${mod_translate.Translator.translate('ch.bfe.energiestaedte-2000watt-areale.name_watt', lang)}
    </th>
    <td>
      ${c['attributes']['name']}
    </td>
  ...
  <tr>
    <th class="cell-meta">
     ${mod_translate.Translator.translate('ch.bfe.energiestaedte-2000watt-areale.state', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${mod_translate.Translator.translate('areal_gemeinde', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${mod_translate.Translator.translate('berater', lang)}
    </th>
...
<br />
  ...
  % else:
    <td class="cell-meta">
      <a target="_blank" href="${c['attributes']['linkfaktenblatt_it'] or '-'}">${mod_translate.Translator.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
...
<br />
  ...
  % else:
    <td class="cell-meta">
      <a target="_blank" href="${c['attributes']['linkfaktenblatt_en'] or '-'}">${mod_translate.Translator.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
...
<br /><br />
<a target="_blank" href="https://www.2000watt.swiss/dam/jcr:f859c9e9-6b96-466f-8288-7a625a41654c/2000_Watt_Flyer_de.pdf">InfoFlyer</a><br />
<br />
     </p></td>
    </tr>
    <th class="cell-meta">
  ...
  % else:
    <td class="cell-meta">
      <a target="_blank" href="${c['attributes']['linkfaktenblatt_de'] or '-'}">${mod_translate.Translator.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
