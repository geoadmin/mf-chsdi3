...
<%def name="table_body(c, lang)">
    ...
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.amtliches-strassenverzeichnis.esid', lang)}</td>                 <td>${c['attributes']['esid'] or '-'}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.amtliches-strassenverzeichnis.label', lang)}</td>                 <td>${c['attributes']['label'] or '-'}</td></tr>
