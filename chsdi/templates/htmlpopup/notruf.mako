...
<% c['stable_id'] = True %>
    ...
    <tr><td class="cell-left">${t.translate('ch.bakom.notruf.name', lang)}</td>    	<td>${c['attributes']['name'] or '-'}</td></tr>
</%def>
...
<table class="table-with-border">
    ...
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.festnetz', lang)}</th>
        <td class="cell-meta">${c['attributes']['festnetz_112'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_112_festnetz', lang)}</th>
        <td class="cell-meta">${_(fn_addresse_112)|n}</td>
    </tr>
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.mobilnetz', lang)}</th>
        <td class="cell-meta">${c['attributes']['mobile_112'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_112_mobil', lang)}</th>
        <td class="cell-meta">${_(mo_addresse_112)|n}</td>
    </tr>
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.satellit', lang)}</th>
        <td class="cell-meta">${c['attributes']['satellit_112'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_112_satellit', lang)}</td>
...
<table class="table-with-border">
    ...
    <tr>
        ...
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_117_festnetz', lang)}</th>
        <td class="cell-meta">${_(fn_addresse_117)|n}</td>
    </tr>
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.mobilnetz', lang)}</th>
        <td class="cell-meta">${c['attributes']['mobile_117'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_117_mobil', lang)}</th>
...
<table class="table-with-border">
    ...
    <tr>
        ...
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_118_festnetz', lang)}</th>
        <td class="cell-meta">${_(fn_addresse_118)|n}</td>
    </tr>
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.mobilnetz', lang)}</th>
        <td class="cell-meta">${c['attributes']['mobile_118'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_118_mobil', lang)}</th>
...
<table class="table-with-border">
    ...
    <tr>
        ...
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_143_festnetz', lang)}</th>
        <td class="cell-meta">${_(fn_addresse_143)|n}</td>
    </tr>
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.mobilnetz', lang)}</th>
        <td class="cell-meta">${c['attributes']['mobile_143'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_143_mobil', lang)}</th>
...
<table class="table-with-border">
    ...
    <tr>
        ...
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_144_festnetz', lang)}</th>
        <td class="cell-meta">${_(fn_addresse_144)|n}</td>
    </tr>
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.mobilnetz', lang)}</th>
        <td class="cell-meta">${c['attributes']['mobile_144'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_144_mobil', lang)}</th>
...
<table class="table-with-border">
    ...
    <tr>
        ...
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_147_festnetz', lang)}</th>
        <td class="cell-meta">${_(fn_addresse_147)|n}</td>
    </tr>
    <tr>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.mobilnetz', lang)}</th>
        <td class="cell-meta">${c['attributes']['mobile_147'] or '-'}</td>
        <th class="cell-meta">${t.translate('ch.bakom.notruf.adresse_147_mobil', lang)}</th>
