...
%>
    <tr><td class="cell-left">${h.translate('ch.bav.sachplan-infrastruktur-schiene_anhorung.facname_de', lang)}</td>                  <td>${c['attributes'][facname]}</td></tr>
...
% if c['attributes']['doc_web']:
    <tr><td class="cell-left">${h.translate('ch.bav.sachplan-infrastruktur-schiene_anhorung.doc_title', lang)}</td>                    <td><a href="${c['attributes']['doc_web']}" target="_blank">${c['attributes']['doc_title'] or '-'}</a></td></tr>
% else:
