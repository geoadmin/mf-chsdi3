...
<tr><td class="cell-left">${Translator.translate('tt_lubis_inventarnummer', lang)}</td>          <td>${c['attributes']['inventarnummer'] or '-'}</td></tr>
<tr>
  <td class="cell-left">${Translator.translate('ch.swisstopo.lubis-terrestrische_aufnahmen.tt_lubis_aufnahmedatum', lang)}</td>
  <td>${datum or '-'}</td>
</tr>
<tr>
...
<body onload="init()">
  <table class="table-with-border kernkraftwerke-extended">
    <tr><th class="cell-left">${Translator.translate('tt_lubis_ebkey', lang)}</th>                   <td>${c['attributes']['image_number'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('tt_lubis_inventarnummer', lang)}</th>          <td>${c['attributes']['inventarnummer'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('ch.swisstopo.lubis-terrestrische_aufnahmen.tt_lubis_aufnahmedatum', lang)}</th>           <td>${datum or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('ch.swisstopo.lubis-terrestrische_aufnahmen.operate_name', lang)}</th>      <td>${c['attributes']['ort'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('ch.swisstopo.lubis-terrestrische_aufnahmen.station', lang)}</th>      <td>${c['attributes']['station'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('tt_lubis_schraegaufnahmen_x', lang)}</th>      <td>${c['attributes']['x'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('tt_lubis_schraegaufnahmen_y', lang)}</th>      <td>${c['attributes']['y'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('tt_lubis_Filmart', lang)}</th>                 <td>${c['attributes']['filmart'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('ch.swisstopo.lubis-luftbilder_schraegaufnahmen.tt_lubis_schraegaufnahmen_medium_format', lang)}</th>                 <td>${c['attributes']['medium_format'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('ch.swisstopo.lubis-terrestrische_aufnahmen.tt_filesize', lang)}</th>                 <td>${c['attributes']['filesize_mb'] or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('tt_lubis_bildpfad', lang)}</th>         <td>${filename or '-'}</td></tr>
    <tr><th class="cell-left">${Translator.translate('link', lang)}</th>
        <td>
% if pdf:
    <a href="${url_pdf}" target="_blank">${Translator.translate('ch.swisstopo.lubis-terrestrische_aufnahmen.expertenlink', lang)} - pdf</a>
% else:
    -
% endif
        </td>
    </tr>
    <tr><th class="cell-left">${Translator.translate('link')} smapshot</th>         <td><a href="${url_smapshot}" target="_blank">${_('link', lang)} smapshot</a></td></tr>
