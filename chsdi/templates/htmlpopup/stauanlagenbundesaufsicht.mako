...
%>
    <tr><td class="cell-left">${t.Translator.translate('ch.bfe.stauanlagen-bundesaufsicht.damname', lang)}</td>              <td>${c['attributes']['damname']}</td></tr>
...
<%def name="extended_info(c, lang)">
    ...
    %>
    <h1>${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_stauanlage', lang)} ${c['attributes']['facilityname']}</h1>
    <table class="table-with-border kernkraftwerke-extended">
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_stauanlage', lang)}</th>
            <td>${c['attributes']['facilityname']}</td>
        </tr>
        <tr>
            <th class="cell-left">${t.Translator.translate('baujahr', lang)}</th>
            <td>${c['attributes']['baujahr'] or '-'}</td>
        </tr>
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_inbetriebabnahme', lang)}</th>
            <td>${c['attributes']['beginningofoperation']}</td>
        </tr>
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_zweck', lang)}</th>
            <td>${c['attributes']['facaim_'+lang]}</td>
        </tr>
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_aufsichtstart', lang)}</th>
        ...
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_stauraum', lang)}</th>
            <td>${c['attributes']['reservoirname']}</td>
        </tr>
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_stauraumvolume', lang)} [Mio m<sup>3</sup>]</th>
        ...
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_stauhoehe', lang)} [m]</th>
        ...
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_sperre', lang)}</th>
            <td>${c['attributes']['damname']}</td>
        </tr>
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_damheight', lang)} [m]</th>
        ...
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_crestlength', lang)} [m]</th>
            <td>${c['attributes']['crestlength']}</td>
        </tr>
        <tr>
            <th class="cell-left">${t.Translator.translate('tt_ch.bfe.stauanlagen-bundesaufsicht_damtype', lang)}</th>
