...
%>
    ...
    <tr><td class="cell-left">${_('baujahr')}</td>                                                <td>${c['attributes']['baujahr'] or '-'}</td></tr>
...
<%def name="extended_info(c, lang)">
    <%
        ...
        img_url = "https://www.uvek-gis.admin.ch/BFE/bilder/ch.bfe.stauanlagen-bundesaufsicht/"+str(c['attributes']['facility_stabil_id'])+".jpg"
    ...
    <table class="table-with-border kernkraftwerke-extended">
        ...
        <tr>
            <th class="cell-left">${_('baujahr')}</th>
