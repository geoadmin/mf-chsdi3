...
%>
    ...
    <tr><td class="cell-left">${h.translate('gemgemeinde', lang)}</td>    <td>${c['attributes']['gemeindename'] or '-'}</td></tr>
    <tr><td class="cell-left">${h.translate('oereb_status', lang)}</td>
% if lang == 'de':
...
% endif
    <tr><td class="cell-left">${h.translate('oereb_firma', lang)}</td>    <td>${c['attributes']['firmenname'] or '-'}</td></tr>
    ...
    <tr><td class="cell-left">${h.translate('Email', lang)}</td>
    ...
    <tr><td class="cell-left">${h.translate('gemdarstellung', lang)}</td>
      % if c['attributes']['url_oereb'] == None:
       <td>-</td>
      % else:
         <td><a target="_blank" href="${c['attributes']['url_oereb']}">${h.translate('link', lang)}</a></td>
      % endif
    </tr>
    % if is_oereb_service:
      % for egrid in list_egrid:
        <tr>
            <td class="cell-left">${h.translate('ch.swisstopo-vd.stand-oerebkataster.oereb_webservice', lang)}</td>
