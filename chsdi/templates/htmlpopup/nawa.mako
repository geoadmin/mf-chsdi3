...
%if c['layerBodId'].startswith('ch.bafu.gewaesserschutz-biologischer_zustand_'):
    <tr><td class="cell-left">${_('ch.bafu.gewaesserschutz-biologischer_zustand_diatomeen.klasse')}</td> <td>${c['attributes'][klasse]}</td></tr>
%endif
