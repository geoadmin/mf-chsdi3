...
%>
    <tr>
      <td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swisstlm3d-strassen.objektart', lang)}</td>
      <td>${_(objektart_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swisstlm3d-strassen.belagsart', lang)}</td>
      <td>${_(belagsart_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swisstlm3d-strassen.verkehrsbedeutung', lang)}</td>
      <td>${_(verkehrsbedeutung_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swisstlm3d-strassen.eigentuemer', lang)}</td>
      <td>${_(eigentuemer_label) or '-'}</td>
    </tr>
    <tr>
      <td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swisstlm3d-strassen.verkehrsbeschraenkung', lang)}</td>
