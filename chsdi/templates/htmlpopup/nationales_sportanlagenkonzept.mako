...
<%def name="table_body(c, lang)">
    ...
    <tr><td class="cell-left">${_('ch.baspo.nationales-sportanlagenkonzept.website')}</td>     <td><a target="_blank" href="http://${c['attributes']['website'].replace("http://","")}">${c['attributes']['website'] or '-'}</a></td</tr>
</%def>
