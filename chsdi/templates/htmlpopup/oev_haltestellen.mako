...
% if type_station == 'Bedienpunkt' :
    ...
    <p>${t.translate('ch.bav.haltestellen-oev.bedienpunkt', lang)}</p>

% elif type_station == 'Anschlusspunkt' :

   <p><b>${c['attributes']['name'] or '-'}</b></p>
   <p>${t.translate('ch.bav.haltestellen-oev.anschlusspunkt', lang)}</p>

% elif type_station == 'reiner_Betriebspunkt' :

   <p><b>${c['attributes']['name'] or '-'}</b></p>
   <p>${t.translate('ch.bav.haltestellen-oev.reiner_betriebspunkt', lang)}</p>
...
$(document).ready(function() {
  ...
  Refresh();
    ...
    <p><b>${c['attributes']['name'] or '-'}</b>, ${t.translate('ch.bav.haltestellen-oev.next_departures', lang)}:</p>
  <table>
    <tr>
...
<table>
  <tr>
      <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.id', lang)}</td>
      <td class="cell-meta">${c['featureId'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.name', lang)}</td>
    <td class="cell-meta">${c['attributes']['name'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.abkuerzung', lang)}</td>
    <td class="cell-meta">${c['attributes']['abkuerzung'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.tuabkuerzung', lang)}</td>
    <td class="cell-meta">${c['attributes']['tuabkuerzung'] or '-'}</td>
  </tr>
  <tr>
    <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.betriebspunkttyp', lang)}</td>

% if type_station == 'Bedienpunkt' :

    <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.bedienpunkt', lang)}</td>

% elif type_station == 'Anschlusspunkt' :

   <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.anschlusspunkt', lang)}</td>

% elif type_station == 'reiner_Betriebspunkt' :

   <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.reiner_betriebspunkt', lang)}</td>

% elif type_station == 'Haltestelle' :

    <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.haltestelle', lang)}</td>

% endif
  </tr>
  <tr>
    <td class="cell-meta">${t.translate('ch.bav.haltestellen-oev.verkehrsmittel', lang)}</td>
  ...
  <tr>
      ...
      <td class="cell-meta"><p><a href="${''.join((c['baseUrl'], '?', c['layerBodId'], '=', str(c['featureId']), '&lang=', lang, '&topic=', topic, '&showTooltip=true'))}" target="new">
        ${t.translate('Link to object', lang)}
      </a></p></td>
  </tr>
</table>
<br />
