...
<tr>
  <td class="cell-left">${h.translate('ch.bfe.energieforschung.titel', lang)}</td>
  <td>${c['attributes']['titel'] or '-'|n}</td>
</tr>
<tr>
  <td class="cell-left">${h.translate('ch.bfe.energieforschung.beschreibung', lang)}</td>
  <td>${c['attributes']['beschreibung'] or '-'|n}</td>
</tr>
<tr>
  <td class="cell-left">${h.translate('ch.bfe.energieforschung.leuchtturm', lang)}</td>
% if c['attributes']['leuchtturm']==0:
      <td class="cell-left">${h.translate('leuchtturm_0', lang)}</td>
% else:
      <td class="cell-left">${h.translate('leuchtturm_1', lang)}</td>
%endif
</tr>
<tr>
  <td class="cell-left">${h.translate('ch.bfe.energieforschung.projektstatus', lang)}</td>
...
<table>
 <colgroup>
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.projektnummer', lang)}
    </td>
    <td class="cell-meta">
  ...
  <tr>
    <td class="cell-meta">${h.translate('ch.bfe.energieforschung.leuchtturm', lang)}</td>
    % if c['attributes']['leuchtturm']==0:
    <td class="cell-meta">${h.translate('leuchtturm_0', lang)}</td>
    % else:
    <td class="cell-meta">${h.translate('leuchtturm_1', lang)}</td>
    %endif
  </tr>
  <tr>
    <td class="cell-meta-one" colspan="2">&nbsp;</td>
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.projektstatus', lang)}
    </td>
    <td class="cell-meta">
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.projektdauer', lang)}
    </td>
    <td class="cell-meta">
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.thema', lang)}
    </td>
    <td class="cell-meta">
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.bericht', lang)}
    </td>
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.fachartikel', lang)}
    </td>
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.infoclip', lang)}
    </td>
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.projektpartner', lang)}
    </td>
    <td class="cell-meta">
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.kontakt', lang)}
    </td>
    <td class="cell-meta">
  ...
  <tr>
    <td class="cell-meta">
      ${h.translate('ch.bfe.energieforschung.projektstandort', lang)}
    </td>
    <td class="cell-meta">
