...
% if 'ord_nr' in c['attributes']:
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.hebungsraten.ord_nr', lang)}</td><td>${c['attributes']['ord_nr'] or '-'}</td></tr>
% endif
% if 'ort' in c['attributes']:
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.hebungsraten.ort', lang)}</td><td>${c['attributes']['ort'] or '-'}</td></tr>
% endif
% if 'v' in c['attributes']:
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.hebungsraten.v', lang)}</td><td>${round(c['attributes']['v'],5) or '0.00'}</td></tr>
% endif
% if 'mfv' in c['attributes']:
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.hebungsraten.mfv', lang)}</td><td>${"%.2f"%c['attributes']['mfv'] or '0'}</td></tr>
% endif
...
% if 'contour' in c['attributes']:
    <tr><td class="cell-left">${t.Translator.translate('ch.swisstopo.hebungsraten.contour', lang)}</td><td>${round(c['attributes']['contour'],1)}</td></tr>
% endif
</%def>
