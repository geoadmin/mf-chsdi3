...
%>
<% c['stable_id'] = True %> 
<tr><td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swissboundaries3d-land-flaeche.fill.id', lang)}</td><td>${c['id'] or '-'}</td></tr>
<tr><td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swissboundaries3d-land-flaeche.fill.name', lang)}</td><td>${c['attributes']['bez']}</td></tr>
