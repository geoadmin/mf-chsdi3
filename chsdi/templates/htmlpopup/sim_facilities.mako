...
%>
    <tr><td class="cell-left">${t.Translator.translate('tt_sachplan_facility_number', lang)}</td>                <td>${c['attributes']['facility']}</td></tr>
    <tr><td class="cell-left">${t.Translator.translate('tt_sachplan_facility_name', lang)}</td>                  <td>${c['attributes'][facname]}</td></tr>
