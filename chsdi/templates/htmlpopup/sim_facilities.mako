...
%>
    <tr><td class="cell-left">${mod_translate.Translator.translate('tt_sachplan_facility_number', lang)}</td>                <td>${c['attributes']['facility']}</td></tr>
    <tr><td class="cell-left">${mod_translate.Translator.translate('tt_sachplan_facility_name', lang)}</td>                  <td>${c['attributes'][facname]}</td></tr>
    ...
    <tr><td class="cell-left">${mod_translate.Translator.translate('tt_sachplan_facility_beschlussdatum', lang)}</td>        <td>${c['attributes']['validfrom'] or '-'}</td></tr>
...
% if c['attributes']['doc_web']:
    <tr><td class="cell-left">${mod_translate.Translator.translate('tt_sachplan_weitereinfo', lang)}</td>                    <td><a href="${c['attributes']['doc_web'] or '-'}" target="_blank">${mod_translate.Translator.translate('tt_sachplan_objektblatt', lang)}</a></td></tr>
% else:
