...
%>
    <tr><td class="cell-left">${t.translate('tt_sachplan_facility_number', lang)}</td>                <td>${c['attributes']['facility']}</td></tr>
...
% if c['attributes']['doc_web']:
    <tr><td class="cell-left">${t.translate('tt_sachplan_weitereinfo')}</td>                    <td><a href="${c['attributes']['doc_web'] or '-'}" target="_blank">${_('tt_sachplan_objektblatt', lang)}</a></td></tr>
% else:
