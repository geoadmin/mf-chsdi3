...
<% c['stable_id'] = False %>
    <tr><td class="cell-left">${_('ch.bav.laermbelastung-eisenbahn_effektive_immissionen_tag.lr_day')}</td> <td>${c['attributes']['lr_day'] or '-'}</td></tr>
    ...
    <tr><td class="cell-left">${_('ch.bav.laermbelastung-eisenbahn_effektive_immissionen_tag.receptor')}</td> <td>${c['attributes']['receptor'] or '-'}</td></tr>
</%def>
