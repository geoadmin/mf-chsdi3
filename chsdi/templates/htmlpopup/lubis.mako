...
<tr>
  <td class="cell-left">${t.translate('tt_lubis_Flugdatum', lang)}</td>
  <td>${datum or '-'}</td>
</tr>
<tr>
...
<body onload="init()">
  <table class="table-with-border kernkraftwerke-extended">
    <tr><th class="cell-left">${t.translate('tt_lubis_ebkey', lang)}</th>            <td>${c['featureId'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_inventarnummer', lang)}</th>   <td>${c['attributes']['inventarnummer'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_Flugdatum', lang)}</th>        <td>${datum or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_flughoehe', lang)}</th>        <td>${c['attributes']['flughoehe'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_massstab', lang)}</th>         <td>1:${c['attributes']['massstab'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_y', lang)}</th>                <td>${c['attributes']['x'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_x', lang)}</th>                <td>${c['attributes']['y'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_Filmart', lang)}</th>          <td>${c['attributes']['filmart'] or '-'}</td></tr>

% if 'contact_image_url' in c['attributes'] and c['attributes']['contact_image_url']:
<tr>
  <th class="cell-left">${t.translate('tt_lubis_url_canton', lang)}</th>
  <td><a href="${c['attributes']['contact_image_url']}" target="_blank">${c['attributes']['contact_image_url']}</a></td>
</tr>
% endif

    <tr><th class="cell-left">${t.translate('tt_lubis_originalsize', lang)}</th>     <td>${c['attributes']['originalsize'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_filesize_mb', lang)}</th>      <td>${filesize_mb or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_bildpfad', lang)}</th>         <td>${filename or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_orthophoto', lang)}</th>       <td>${c['attributes']['orthophoto'] or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_orientierung', lang)}</th>     <td>${orientierung or '-'}</td></tr>
    <tr><th class="cell-left">${t.translate('tt_lubis_rotation', lang)}</th>         <td>${c['attributes']['rotation'] or '-'}</td></tr>
