...
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('ch.bfe.energiestaedte.name', lang)}</td>
  <td>${c['attributes']['name'] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('ch.bfe.energiestaedte.punktezahl', lang)}</td>
  <td>${c['attributes']['punktezahl'] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('ch.bfe.energiestaedte.einwohnerzahl', lang)}</td>
  <td>${int(c['attributes']['einwohner']) or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${mod_translate.Translator.translate('ch.bfe.energiestaedte.energiestadtseit', lang)}</td>
...
<table class="table-with-border kernkraftwerke-extended" cellpadding="5">
  <tr>
    <th class="cell-meta">
      ${mod_translate.Translator.translate('ch.bfe.energiestaedte.name', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${mod_translate.Translator.translate('ch.bfe.energiestaedte.punktezahl', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${mod_translate.Translator.translate('ch.bfe.energiestaedte.einwohnerzahl', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${mod_translate.Translator.translate('ch.bfe.energiestaedte.energiestadtseit', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${mod_translate.Translator.translate('ch.bfe.energiestaedte.beteiligtegemeinde', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta" >
      ${mod_translate.Translator.translate('ch.bfe.energiestaedte.anzahlaudits', lang)}
    </th>
    <td class="cell-meta">
  ...
  <tr>
    <th class="cell-meta" >
      ${mod_translate.Translator.translate('ch.bfe.energiestaedte.berater', lang)}
    </th>
    <td class="cell-meta">
