...
<tr>
  <td class="cell-left">${Translator.translate('ch.bfe.energiestaedte.name', lang)}</td>
  <td>${c['attributes']['name'] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${Translator.translate('ch.bfe.energiestaedte.punktezahl', lang)}</td>
  <td>${c['attributes']['punktezahl'] or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${Translator.translate('ch.bfe.energiestaedte.einwohnerzahl', lang)}</td>
  <td>${int(c['attributes']['einwohner']) or '-'}</td>
</tr>
<tr>
  <td class="cell-left">${Translator.translate('ch.bfe.energiestaedte.energiestadtseit', lang)}</td>
...
<table class="table-with-border kernkraftwerke-extended" cellpadding="5">
  <tr>
    <th class="cell-meta">
      ${Translator.translate('ch.bfe.energiestaedte.name', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${Translator.translate('ch.bfe.energiestaedte.punktezahl', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${Translator.translate('ch.bfe.energiestaedte.einwohnerzahl', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${Translator.translate('ch.bfe.energiestaedte.energiestadtseit', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta">
      ${Translator.translate('ch.bfe.energiestaedte.beteiligtegemeinde', lang)}
    </th>
    <td>
  ...
  <tr>
    <th class="cell-meta" >
      ${Translator.translate('ch.bfe.energiestaedte.anzahlaudits', lang)}
    </th>
    <td class="cell-meta">
  ...
  <tr>
    <th class="cell-meta" >
      ${Translator.translate('ch.bfe.energiestaedte.berater', lang)}
    </th>
    <td class="cell-meta">
  ...
  <tr>
    <th class="cell-meta">
     ${Translator.translate('ch.bfe.energiestaedte.linkenergiestadtweb', lang)}
    </th>
  % if c['attributes']['linkenergiestadtweb'] is None:
    <td class="cell-meta"> - </td>
  % else:
    <td class="cell-meta">
       <a target="_blank" href="${c['attributes']['linkenergiestadtweb']}">${Translator.translate('link', lang)}</a>
    </td>
  % endif
  </tr>
  <tr>
   <th class="cell-meta" colspan="2">
    ${Translator.translate('ch.bfe.energiestaedte.erklaerung', lang)}
    </th>
  </tr>
  <tr>
  % if lang=='fr' :
