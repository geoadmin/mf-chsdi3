...
%>
<% c['stable_id'] = True %> 
<tr><td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swissboundaries3d-kanton-flaeche.fill.ak', lang)}</td><td>${c['attributes']['ak'] or '-'}</td></tr>
<tr><td class="cell-left">${mod_translate.Translator.translate('ch.swisstopo.swissboundaries3d-kanton-flaeche.fill.name', lang)}</td><td>${c['attributes']['name']}</td></tr>
